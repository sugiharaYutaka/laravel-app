            ...
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        @else
                            <a href="{{ route('uploadVideo') }}" class="btn border-top border-bottom my-2">動画投稿</a><br>
                            <a href="{{ url('/live', session('user_id') ) }}" class="btn border-top border-bottom my-2">配信</a><br>
